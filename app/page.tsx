...
export default function Home() {
  ...
  const [ themePack, setThemePack ] = useState<ThemePack>(dopplerTheme);
  const [ prevTheme, setPrevTheme ] = useState<ThemePack>(dopplerTheme);
  ...
  return (
     ...
     <div className={themePack ? "body " + themePack.background : "body mt-4"}>
      <motion.div initial={{ opacity: 0}}
          ...
          className={themePack ? " mx-5 mb-10 h-[100vh] " + themePack.font2 : "border mx-10 mb-10 h-[100vh]"}>
