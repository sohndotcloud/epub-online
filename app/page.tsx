  ...
  return (
    ...
    <div className="h-10 w-full flex dark:bg-neutral-900">
        <motion.h1
          ...
          className="mt-2 w-full text-center md:pl-10 w-50 font-mono font-extrabold text-l p-5 text-[20px] mt-2 lg:text-[24px] w-80 dark:text-amber-300"><Link href="/">Nils Sohn</Link></motion.h1>
